About python-lsp-ruff-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-lsp-ruff-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-lsp-ruff-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-lsp-ruff
# for installing globally
pixi global install python-lsp-ruff
```
...
It is possible to list all of the versions of `python-lsp-ruff` available on your platform:
...
```
pixi search python-lsp-ruff --channel conda-forge
```
